...
void testerGesture(struct handGesture * gesture)
{
  ...
  char command[512]={0};
    switch (gesture->gestureID)
    {
     ...
     case GESTURE_CANCEL : payload=1; snprintf(command,512,"wget -qO- http://127.0.0.1:8080/index.html?RIGHT=1 &> /dev/null"); break;
     case GESTURE_HELP   : payload=1; snprintf(command,512,"eject &");  break;
     case GESTURE_YES    : payload=1; snprintf(command,512,"wget -qO- http://192.168.1.19:8080/commander.html?activate=a &> /dev/null");
                                      snprintf(command,512,"wget -qO- http://127.0.0.1:8080/commander.html?activate=a &> /dev/null");   break;
     case GESTURE_NO     : payload=1;
                                      snprintf(command,512,"wget -qO- http://192.168.1.19:8080/commander.html?deactivate=a &> /dev/null");
                                      snprintf(command,512,"wget -qO- http://127.0.0.1:8080/commander.html?deactivate=a &> /dev/null");
                                      break;
     case GESTURE_REWARD : payload=1;
                                      snprintf(command,512,"wget -qO- http://127.0.0.1:8080/index.html?STARS=1 &> /dev/null");
                                      snprintf(command,512,"wget -qO- http://127.0.0.1:8080/commander.html?deactivate=all &> /dev/null");
                                      break;
     case GESTURE_POINT  : break;
     case GESTURE_COME   :  payload=1;  snprintf(command,512,"wget -qO- http://127.0.0.1:8080/commander.html?activate=b &> /dev/null");   break;
     case GESTURE_WAVE   :  payload=1;  snprintf(command,512,"wget -qO- http://127.0.0.1:8080/commander.html?deactivate=b &> /dev/null");break;
     default :              break;
    };
