...
AMMAR_SERVER_LIBS=""
if [ -e "AmmarServer/src/AmmServerlib/libAmmServerlib.so" ] 
then
 AMMAR_SERVER_LIBS="AmmarServer/src/AmmServerlib/libAmmServerlib.so"
elif [ -e "AmmarServer/src/AmmServerNULLlib/libAmmServerlib.so" ] 
then
 AMMAR_SERVER_LIBS="AmmarServer/src/AmmServerNULLlib/libAmmServerlib.so"
fi
...
gcc -s main.c  $CFLAGS $ACQUISITION_LIBRARY $OPENNI1_LIBS $OPENNI2_LIBS $FREENECT_LIBS $OPENGL_SANDBOX_LIBS $TEMPLATE_LIBS $AMMAR_SERVER_LIBS -L. -o acquisitionBroadcast
