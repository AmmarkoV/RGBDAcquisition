/** @file acqusition_setup.h
 *  @brief Setup Header to control features compiled ( or not )
 *
 *   THIS IS THE SUPER HEADER FILE WHICH CONTROLS WHAT WILL BE COMPILED AND WHAT NOT !!
 ...
 *  @bug Wrong settings here could cause empty versions of plugins
 */
