...
const long SelectTarget::ID_CHECKBOX1 = wxNewId();
//*)
...
SelectTarget::SelectTarget(wxWindow* parent,wxWindowID id)
{
	...
	SetClientSize(wxSize(339,238));
	StaticBox1 = new wxStaticBox(this, ID_STATICBOX1, _("Target Selection"), wxPoint(16,16), wxSize(312,208), 0, _T("ID_STATICBOX1"));
	...
	ButtonRecord = new wxButton(this, ID_BUTTON1, _("Record"), wxPoint(24,184), wxSize(192,29), 0, wxDefaultValidator, _T("ID_BUTTON1"));
	ButtonCancel = new wxButton(this, ID_BUTTON2, _("Cancel"), wxPoint(232,184), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
	CheckBoxCompressOutput = new wxCheckBox(this, ID_CHECKBOX1, _("Compress output"), wxPoint(24,152), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
	CheckBoxCompressOutput->SetValue(false);
...
void SelectTarget::OnButtonRecordClick(wxCommandEvent& event)
{
  ...
  if ( CheckBoxCompressOutput->GetValue() ) { compressRecording=1; } else
                                            { compressRecording=0; }
