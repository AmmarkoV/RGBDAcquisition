...
const long SelectAcquisitionGraph::ID_STATICTEXT1 = wxNewId();
...
SelectAcquisitionGraph::SelectAcquisitionGraph(wxWindow* parent,wxWindowID id)
{
	...
	Panel1 = new wxPanel(this, ID_PANEL1, wxPoint(40,88), wxSize(224,144), wxTAB_TRAVERSAL, _T("ID_PANEL1"));
	ComboBox1 = new wxComboBox(Panel1, ID_COMBOBOX1, wxEmptyString, wxPoint(16,48), wxSize(192,25), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX1"));
	...
	StaticText1 = new wxStaticText(Panel1, ID_STATICTEXT1, _("StreamLabel"), wxPoint(16,16), wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	//*)
}
