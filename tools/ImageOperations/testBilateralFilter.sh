...
./imageopsutility $SRCIMG output6.jpg --contrast 2.9 --bilateral 225.0 226.0 $WINDOWSIZE
./imageopsutility $SRCIMG output7.jpg --contrast 2.9 --bilateral 255.0 256.0 $WINDOWSIZE
