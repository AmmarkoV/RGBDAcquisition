...
then
 ldd $BIN | grep not
 LD_LIBRARY_PATH=.:../3dparty/libfreenect/build/lib ./$BIN -module TEMPLATE -from floor -maxFrames 10 -to floorSegmented -autoplane 10 -calibration frames/floor/color.calib -combine AND $@  &> ../error.txt
