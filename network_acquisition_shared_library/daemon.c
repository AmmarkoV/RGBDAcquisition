...
{
  #if USE_AMMARSERVER
    return ammarserver_UpdateFrameServerImages(frameServerID,streamNumber,pixels,width,height,channels,bitsperpixel);
  #endif // USE_AMMARSERVER
...
{
  #if USE_AMMARSERVER
     return ammarserver_StartFrameServer(devID ,bindAddr,bindPort);
  #endif // USE_AMMARSERVER
...
{
  #if USE_AMMARSERVER
    return ammarserver_StopFrameServer(devID);
  #endif // USE_AMMARSERVER
