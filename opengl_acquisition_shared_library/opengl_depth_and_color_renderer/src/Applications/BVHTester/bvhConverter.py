...
class BVH():
  ...
  def fineTuneToMatch(self,bodyPart:str,target:dict,frameID=0,iterations=10,epochs=30,lr=0.01,fSampling=30.0,fCutoff=5.0):
    ...
    self.libBVH.bvhConverter_IKFineTune.argtypes = [ctypes.c_char_p, ctypes.POINTER(ctypes.c_char_p), ctypes.POINTER(ctypes.c_float), ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.c_float, ctypes.c_float, ctypes.c_float]
