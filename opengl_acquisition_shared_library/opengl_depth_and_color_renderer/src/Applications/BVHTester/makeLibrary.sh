...
gcc -shared -o libBVHConverter.so -D_GNU_SOURCE -O3 -g3 -fno-omit-frame-pointer -pg -Wstrict-overflow  -fPIC $EXTRA_FLAGS -march=native -mtune=native -lm -DBVH_USE_AS_A_LIBRARY $SOURCE
